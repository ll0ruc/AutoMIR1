...
from peft import LoraConfig, TaskType, get_peft_model, PeftModel, prepare_model_for_kbit_training, PeftConfig
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        data_files = {}
        if data_args.train_file_dir is not None and os.path.isfile(data_args.train_file_dir):
    ...
    lora_model_path = training_args.output_dir
    output_dir = lora_model_path.replace("lora", "merge")
